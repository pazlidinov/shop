...
urlpatterns = [
    ...
    path('sort_by_category/<int:id>', views.sort_by_category, name="sort_by_category"),
    
    
    path('sort_by_category/<str:key_word>', views.sort_key_products, name="sort_key_products"),
